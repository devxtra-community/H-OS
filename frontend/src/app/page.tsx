...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#1E293B] font-sans antialiased selection:bg-[#1A5ABA]/20 selection:text-[#1A5ABA]">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#1A5ABA] to-[#3B82F6] flex items-center justify-center text-white shadow-md shadow-blue-600/20 group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-xs"
              >
                <LogIn className="w-4 h-4 text-[#1A5ABA]" />
              ...
              {portalDropdownOpen && (
                <div
                  ...
                  className="absolute right-0 mt-2 w-64 rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-900/10 p-2 z-50"
                >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-blue-50/80 transition-colors group"
                  >
                    <div className="w-8 h-8 rounded-lg bg-blue-100 text-[#1A5ABA] flex items-center justify-center group-hover:bg-[#1A5ABA] group-hover:text-white transition-colors">
                      <UserCheck className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="text-sm font-semibold text-slate-900">Patient Portal</div>
                      <div className="text-[11px] text-slate-500">Book visits & prescriptions</div>
                    </div>
                  </Link>
                  ...
                  <Link
                    href="/staff/login"
                    onClick={() => setPortalDropdownOpen(false)}
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-emerald-50/80 transition-colors group"
                  >
                    ...
                    <div>
                      <div className="text-sm font-semibold text-slate-900">Clinical Staff</div>
                      <div className="text-[11px] text-slate-500">Doctors, nurses & pharmacy</div>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500">Operations & facility audit</div>
                    </div>
                  </Link>
                </div>
              )}
          ...
          <div className="lg:hidden bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-4 shadow-lg">
            ...
            <div className="pt-2 border-t border-slate-100 space-y-2">
              ...
              <Link
                href="/admin/login"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-slate-100 text-slate-800 text-sm font-semibold"
              >
                <span className="flex items-center gap-2">
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-blue-100/40 via-sky-50/20 to-transparent pointer-events-none -z-10 blur-3xl" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            {/* Pill Badge */}
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide bg-[#1A5ABA]/10 text-[#1A5ABA] border border-[#1A5ABA]/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-3">
              <Link
                href="/login"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-2xl bg-[#1A5ABA] hover:bg-[#144794] text-white text-base font-semibold shadow-lg shadow-blue-600/25 hover:shadow-xl hover:shadow-blue-600/35 transition-all duration-200 active:scale-98"
              >
              ...
              <Link
                href="/staff/login"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 text-base font-semibold shadow-xs hover:shadow-md transition-all duration-200 active:scale-98"
              >
              ...
              <Link
                href="/admin/login"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white text-base font-semibold shadow-xs hover:shadow-md transition-all duration-200 active:scale-98"
              >
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-slate-500 font-medium">
          ...
          {/* Hero Showcase Image with Floating Badges */}
          <div className="mt-14 relative max-w-5xl mx-auto">
            <div className="relative rounded-3xl overflow-hidden border border-slate-200/80 shadow-2xl shadow-slate-900/10 bg-slate-100">
              ...
              <div className="absolute bottom-6 left-6 right-6 sm:right-auto bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/60 flex items-center gap-4 max-w-md">
              ...
              <div className="hidden sm:flex absolute top-6 right-6 bg-white/95 backdrop-blur-md rounded-2xl p-3.5 shadow-xl border border-white/60 items-center gap-3">
      ...
      <section id="features" className="py-20 md:py-28 bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group">
      ...
      <section id="services" className="py-20 md:py-28 bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {(() => {
            ...
            return (
              <div className="bg-[#FAFAFA] rounded-3xl border border-slate-200/80 p-8 sm:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
      ...
      {/* -------------------- Dedicated H-OS Portals Gateway Section -------------------- */}
      <section id="portals" className="py-20 md:py-28 bg-[#F6F7F9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-base text-slate-600">
              Access the dedicated operational portal tailored to your role. Seamlessly connect patients, medical practitioners, and hospital administration.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1: Patient Portal */}
            <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              ...
              <div className="pt-8 space-y-2.5">
                <Link
                  href="/login"
                  className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#1A5ABA] hover:bg-[#154694] text-white text-sm font-semibold shadow-md shadow-blue-700/20 transition-all"
                >
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              ...
              <div className="pt-8">
                <Link
                  href="/staff/login"
                  className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold shadow-md transition-all"
                >
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Enterprise facility management, staff account provisioning, ward configuration, and real-time clinical audit trails.
                </p>

                <ul className="space-y-2.5 pt-2 text-xs font-medium text-slate-700">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-purple-600" />
                    <span>Staff & Doctor Accounts Management</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-purple-600" />
                    <span>Bed History & Patient Assignment Logs</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-purple-600" />
                    <span>Pharmacy Dispensing Telemetry & Audits</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="pt-8">
                <Link
                  href="/admin/login"
                  className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-purple-900 hover:bg-purple-950 text-white text-sm font-semibold shadow-md transition-all"
                >
                ...
                <div className="text-center mt-2.5">
                  <span className="text-xs text-slate-400">
                    Hospital Operations & Executive Access
                  </span>
                </div>
              </div>
            </div>
      ...
      <section id="facilities" className="py-20 md:py-28 bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Facility 1 */}
            <div className="bg-[#FAFAFA] rounded-3xl p-8 border border-slate-200 flex flex-col sm:flex-row gap-6 items-start">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {testimonials.map((t, idx) => (
              <div
                key={idx}
                className="bg-[#FAFAFA] rounded-3xl p-7 border border-slate-200 flex flex-col justify-between"
              >
                <div className="space-y-4">
                ...
                <div className="pt-6 mt-6 border-t border-slate-200/80 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#1A5ABA] to-blue-400 text-white font-bold text-sm flex items-center justify-center">
                    {t.name.charAt(0)}
                  </div>
                  <div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 py-5 text-left flex items-center justify-between gap-4 font-semibold text-slate-900 hover:text-[#1A5ABA] transition-colors"
                  >
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl bg-gradient-to-r from-[#143D73] via-[#1A5ABA] to-[#2563EB] text-white p-8 sm:p-14 overflow-hidden shadow-2xl shadow-blue-900/20">
            {/* Background pattern */}
